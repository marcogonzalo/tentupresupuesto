...
Ttp::Application.configure do
  ...
  config.assets.precompile = ['*.svg', '*.eot', '*.woff', '*.ttf', '*.otf', '*.js', '*.ico']
  ...
  config.assets.precompile += ['categorias*', 'mensajes*', 'presupuestos*', 'proveedores*', 'reputacion*', 'trabajos*', 'ubicaciones_geograficas*']
