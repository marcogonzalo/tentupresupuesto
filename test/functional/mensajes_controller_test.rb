...
class MensajesControllerTest < ActionController::TestCase
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post :create, mensaje: { comentario: @mensaje.comentario, usuario: @mensaje.usuario, visto: @mensaje.visto }
    end
  ...
  test "should update mensaje" do
    put :update, id: @mensaje, mensaje: { comentario: @mensaje.comentario, usuario: @mensaje.usuario, visto: @mensaje.visto }
    assert_redirected_to mensaje_path(assigns(:mensaje))
  end
