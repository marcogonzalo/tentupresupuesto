...
class CategoriasControllerTest < ActionController::TestCase
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post :create, categoria: { categoria_id: @categoria.categoria_id, descripcion: @categoria.descripcion, nombre: @categoria.nombre, slug: @categoria.slug }
    end
  ...
  test "should update categoria" do
    put :update, id: @categoria, categoria: { categoria_id: @categoria.categoria_id, descripcion: @categoria.descripcion, nombre: @categoria.nombre, slug: @categoria.slug }
    assert_redirected_to categoria_path(assigns(:categoria))
  end
