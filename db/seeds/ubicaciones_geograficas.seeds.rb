...
#1
  ...
  if estado
    ...
    if municipio
      ...
      UbicacionGeografica.find_or_create_by_nombre_and_entidad_id('Juán Pablo II', :tipo => 'localidad', :entidad_id =>  municipio.id)
      UbicacionGeografica.find_or_create_by_nombre_and_entidad_id('Juán Vives Suriá', :tipo => 'localidad', :entidad_id =>  municipio.id)
      ...
      UbicacionGeografica.find_or_create_by_nombre_and_entidad_id('Los Jardines', :tipo => 'localidad', :entidad_id =>  municipio.id)
      UbicacionGeografica.find_or_create_by_nombre_and_entidad_id('Maripérez', :tipo => 'localidad', :entidad_id =>  municipio.id)
      UbicacionGeografica.find_or_create_by_nombre_and_entidad_id('Montalbán', :tipo => 'localidad', :entidad_id =>  municipio.id)
...
#15
  ...
  if estado
    ...
    if municipio
      ...
      UbicacionGeografica.find_or_create_by_nombre_and_entidad_id('Santa Secilia', :tipo => 'localidad', :entidad_id =>  municipio.id)
