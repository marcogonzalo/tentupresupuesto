(function() {
    var $, validateElement, validateForm, validatorsFor, __indexOf = [].indexOf ||
    function(item) {
    ...
    if (window.ClientSideValidations.forms ===
    void 0) {
    ...
    window.ClientSideValidations.validators = {
        ...
        local : {
            ...
            acceptance : function(element, options) {
                ...
                switch (element.attr('type')) {
                    case 'checkbox':
                        ...
                        break;
                    case 'text':
                        if (element.val() !== ((( _ref = options.accept) != null ? _ref.toString() :
                        void 0) || '1')) {
                            return options.message;
                        }
                }
            ...
            length : function(element, options) {
                ...
                blankOptions = {};
                blankOptions.message = options.is ? options.messages.is : options.minimum ? options.messages.minimum :
                void 0;
    ...
    window.ClientSideValidations.disableValidators = function() {
        ...
        if (window.ClientSideValidations.disabled_validators ===
        void 0) {
            return;
        }
