module EvaluacionesHelper
  def mostrar_reputacion(reputacion, valoraciones, tipo = "general")
    ...
    if valoraciones > 0
      ...
      if tipo == "proveedor"
        return '<div class="reputacion"><span class="sin-evaluar">0 evaluaciones</span></div>'
      else
        return '<div class="reputacion"><div class="'+rep+'" title="Sin evaluar"><span style="width:0%;"><i>0 evaluaciones</i></span></div></div>'
      end
    end
  end
